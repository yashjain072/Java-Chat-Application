 ...
 * @author Yash Jain
 */
public class Chat11 extends javax.swing.JFrame {
    ...
    private void sendMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_sendMouseClicked
        ...
        try {
            ...
            Logger.getLogger(Chat11.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_sendMouseClicked
    
    private static void initServerChat()
    {
        String msgin ="";
        try{
...
/*    private void scrollToBottom() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Chat11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Chat11().setVisible(true);
            }
        });
        Chat11.initServerChat();
    }
